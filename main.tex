...
\resumeSubheading
{Snap}{Seattle, WA}
{Senior Quality Engineer(QE)}{Nov 2023 - Present}
\resumeItemListStart
\resumeItem{Snap Safety Division}{SW Development and Quality Assurance of Snap Safety back-end tools. Use of AWS and GCP (Kubernetes) combined with OOP (Typescript, Java, Kotlin) languages and Go for Integration and End-to-End testing. }
\resumeItemListEnd
\resumeSubheading
{Amazon}{Seattle, WA}
{Software Developer Engineer in Test (SDE-T)}{Jan 2022 - Oct 2023}
\resumeItemListStart
...
{Python, Java, TypeScript, Go, C++, SQL, Scala}
\resumeItem{Operating Systems}
{Linux: CentOS 6.X, Linux Enterprise 10/11, Amazon Linux}
\resumeItem{Technologies}
{AWS (Athena, S3, Glue, Step Function, Lambda, DDB), GCP, TestNG, Mockito, Lombok, JUnit, Dagger, GitHub \& Git, Selenium, Appium, Spark, Jira, Bitbucket}
\resumeSubHeadingListEnd

% MERGED WITH CERTIFICATIONS
%--------TRAININGS------------
%\section{Trainings}
%	\resumeSubHeadingListStart
